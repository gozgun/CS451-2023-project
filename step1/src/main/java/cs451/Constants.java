...
public class Constants {
    ...
    // sizes for queues
    public static final int DELIVERER_QUEUE_SIZE = 16000;
    public static final int CLIENT_QUEUE_SIZE = 8000;
    public static final int CLIENT_ACK_QUEUE_SIZE = 16000;
    public static final int SL_MAP_SIZE = 8000;
}
